...
public class Front extends JFrame {
	...
	{	
		...
		Object[][] data = {
			    ...
			    {new Integer(5), new Integer(5),
					    	new Integer(5), "Gr�ner Stift", new Integer(3000)}
		};
		...
		zwei.addActionListener(new ActionListener() { 
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(getContentPane(),"Hier k�nnte ihre Nachricht stehen","�berschrift", JOptionPane.INFORMATION_MESSAGE);
			}
